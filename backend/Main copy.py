...
if __name__ == "__main__":
    ...
    for person_num, person in enumerate(event_people):
        ...
        for appearance in person.appearances:
            ...
            save_path = "backend/runtime_temp/figures/person_" + str(person_num) + "/person_" + str(person_num)  + "_photo_" + str(appearance.photo_num) + "_features.jpg"
            os.makedirs(os.path.dirname(save_path), exist_ok=True)
            cv2.imwrite(save_path, appearance.figure.feature_card)

            # Save person image
            save_path = "backend/runtime_temp/figures/person_" + str(person_num) + "/person_" + str(person_num)  + "_photo_" + str(appearance.photo_num) + ".jpg"
